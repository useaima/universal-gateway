    ...
    <section id="features" className="py-24">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="light-card group overflow-hidden transition-all duration-300 hover:shadow-[0_26px_62px_rgba(118,86,33,0.18)] hover:-translate-y-1">
            <div className="h-48 overflow-hidden">
              <img src="/assets/images/multi_chain_routing.png" alt="Multi-Chain Routing" className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
            <div className="p-8">
              <Zap className="mb-6 h-10 w-10 text-[#c18b27] transition-transform group-hover:rotate-12" />
          ...
          <div className="light-card group overflow-hidden transition-all duration-300 hover:shadow-[0_26px_62px_rgba(118,86,33,0.18)] hover:-translate-y-1">
            <div className="h-48 overflow-hidden">
              <img src="/assets/images/biometric_firewall.png" alt="Always-on HITL security" className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
            <div className="p-8">
              <ShieldCheck className="mb-6 h-10 w-10 text-amber-600 transition-transform group-hover:rotate-12" />
          ...
          <div className="light-card group overflow-hidden transition-all duration-300 hover:shadow-[0_26px_62px_rgba(118,86,33,0.18)] hover:-translate-y-1">
            <div className="h-48 overflow-hidden">
              <img src="/assets/images/autonomous_ai_agents.png" alt="Truthful maturity labels" className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
            <div className="p-8">
              <Bot className="mb-6 h-10 w-10 text-emerald-600 transition-transform group-hover:rotate-12" />
