      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="light-card p-10">
            <p className="text-xs font-mono uppercase tracking-[0.22em] text-[#9a8357]">Stable users</p>
          ...
          <div className="light-card p-10">
            <p className="text-xs font-mono uppercase tracking-[0.22em] text-[#9a8357]">Beta and experimental users</p>
